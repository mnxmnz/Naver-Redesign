  ...
  return (
    <DetailCardWrap>
      <div className="card--top">
        <figure className="card--top--cardimage">
          {/* <img src={CardImage} className="card--top--cardimage" /> */}
          <img src={PlayIcon} className="card--top--playicon" />
          <div className="card--top--time">05:45</div>
        </figure>
      </div>
      <div className="card--bottom">
        <div className="card--bottom--kind">결산</div>
        <div className="card--bottom--title">[2020- 2021결산] 도드람 V-리그 - 기록</div>
        <div className="card--bottom--category">프로배구 네이버스포츠 · 59분 전</div>
      </div>
    </DetailCardWrap>
  );
}
